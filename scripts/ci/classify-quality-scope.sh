...
is_ci_classifier_file() {
  case "$1" in
    scripts/ci/*|tests/ci/*|scripts/ownership/*|tests/ownership/*|config/resource-ownership-contract.json|config/resource-lifecycle-callsites.json|config/application-lifecycle-authorities.json|docs/adr/0005-resource-ownership-and-cleanup-receipts.md|docs/reference/resource-ownership-cleanup.md|config/ci-toolchain-lock.json|config/hardware-emulator-source-inventory.json|.github/actions/setup-node-toolchain/action.yml|.github/workflows/test.yml|.github/workflows/install-test.yml|.github/workflows/quality.yml|.github/workflows/verify-vectors.yml)
      return 0
      ;;
