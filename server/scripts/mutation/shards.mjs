...
const SHARDS = {
  ...
  3: {
    ...
    mutate: [
      ...
      'src/services/bitcoin/signingIntent/**/*.ts',
      'src/repositories/transactionSigningIntentRepository.ts',
      'src/services/bitcoin/transactions/broadcasting.ts',
      'src/api/transactions/broadcasting.ts',
