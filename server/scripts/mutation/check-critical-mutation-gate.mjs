...
const WEIGHTED_PATH_RULES = [
  ...
  { prefix: 'src/services/bitcoin/signingIntent/', weight: 5 },
  { prefix: 'src/repositories/transactionSigningIntentRepository.ts', weight: 5 },
  { prefix: 'src/api/transactions/broadcasting.ts', weight: 5 },
  { prefix: 'src/services/bitcoin/transactions/broadcasting.ts', weight: 5 },
