 ...
 *
 * Query helpers for read-only AI-facing surfaces. These keep MCP and Console
 * adapters behind the repository boundary while preserving explicit, redacted
 * DTO shaping in the shared tool layer.
 */
