...
export const syncSchemas = {
  ...
  WalletSyncStatus: {
    ...
    required: ['lastSyncedAt', 'syncStatus', 'syncInProgress', 'isStale', 'queuePosition'],
  },
  ...
  NetworkSyncStatusResponse: {
    ...
    required: ['network', 'total', 'syncing', 'synced', 'failed', 'pending', 'lastSyncAt'],
  },
...
export const bitcoinSchemas = {
  ...
  BitcoinMempoolBlock: {
    ...
    required: ['height', 'medianFee', 'feeRange', 'size', 'time', 'status', 'txCount'],
    additionalProperties: true,
  },
  BitcoinMempoolResponse: {
    ...
    properties: {
      ...
      queuedBlocksSummary: {
        ...
        required: ['blockCount', 'totalTransactions', 'averageFee', 'totalFees'],
      },
      stale: { type: 'boolean' },
    },
  ...
  RbfResponse: {
    ...
    required: ['psbtBase64', 'fee', 'feeRate', 'feeDelta', 'inputs', 'outputs', 'inputPaths'],
  },
  CpfpRequest: {
    type: 'object',
    properties: {
    ...
    required: ['parentTxid', 'parentVout', 'targetFeeRate', 'recipientAddress', 'walletId'],
    additionalProperties: false,
  },
  CpfpResponse: {
    type: 'object',
    ...
    required: ['psbtBase64', 'childFee', 'childFeeRate', 'parentFeeRate', 'effectiveFeeRate'],
  },
  ...
  BatchTransactionResponse: {
    ...
    required: ['psbtBase64', 'fee', 'totalInput', 'totalOutput', 'changeAmount', 'savedFees', 'recipientCount'],
  },
