...
export const adminAgentSchemas = {
  ...
  AdminAgentOptions: {
    ...
    properties: {
      users: {
        type: 'array',
        items: { $ref: '#/components/schemas/AdminAgentOptionUser' },
      },
      wallets: {
        type: 'array',
        items: { $ref: '#/components/schemas/AdminAgentOptionWallet' },
      },
      devices: {
        type: 'array',
        items: { $ref: '#/components/schemas/AdminAgentOptionDevice' },
      },
    },
  ...
  AdminAgentWalletDashboardRow: {
    ...
    properties: {
      ...
      recentFundingDrafts: {
        type: 'array',
        items: { $ref: '#/components/schemas/AdminAgentDashboardDraft' },
      },
      recentOperationalSpends: {
        type: 'array',
        items: { $ref: '#/components/schemas/AdminAgentDashboardTransaction' },
      },
      recentAlerts: {
        type: 'array',
        items: { $ref: '#/components/schemas/AdminAgentAlert' },
      },
    },
    required: [
      'agent',
  ...
  AdminWalletAgent: {
    ...
    properties: {
      ...
      fundingWallet: {
        $ref: '#/components/schemas/AdminWalletAgentWalletSummary',
      },
      operationalWallet: {
        $ref: '#/components/schemas/AdminWalletAgentWalletSummary',
      },
      signerDevice: {
        $ref: '#/components/schemas/AdminWalletAgentSignerDevice',
        nullable: true,
      },
      apiKeys: {
        type: 'array',
        items: { $ref: '#/components/schemas/AdminAgentApiKey' },
      },
    },
    required: [
      'id',
  ...
  AdminCreateWalletAgentRequest: {
    ...
    required: ['userId', 'name', 'fundingWalletId', 'operationalWalletId'],
    additionalProperties: false,
  },
  ...
  AdminCreateAgentFundingOverrideRequest: {
    type: 'object',
    properties: {
      maxAmountSats: { type: 'string' },
      expiresAt: { type: 'string', format: 'date-time' },
    ...
    required: ['maxAmountSats', 'expiresAt', 'reason'],
    additionalProperties: false,
  },
