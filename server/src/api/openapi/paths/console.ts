...
export const consolePaths = {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: {
                  tools: { type: 'array', items: { $ref: '#/components/schemas/ConsoleTool' } },
                },
                required: ['tools'],
              },
            },
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: {
                  sessions: { type: 'array', items: { $ref: '#/components/schemas/ConsoleSession' } },
                },
                required: ['sessions'],
              },
            },
          ...
          'application/json': {
            schema: {
              ...
              properties: {
                ...
                maxSensitivity: { type: 'string', enum: ['public', 'wallet', 'high', 'admin'] },
        ...
        '201': {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: { session: { $ref: '#/components/schemas/ConsoleSession' } },
                required: ['session'],
              },
            },
          },
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: {
                  turns: { type: 'array', items: { $ref: '#/components/schemas/ConsoleTurn' } },
                },
                required: ['turns'],
              },
            },
  ...
  '/console/turns': {
    post: {
      tags: ['Console'],
      summary: 'Run a Console turn with model planning and backend tool execution',
      security: auth,
      requestBody: {
        required: true,
        content: {
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  promptHistory: { $ref: '#/components/schemas/ConsolePromptHistory' },
  ...
  '/console/prompts': {
    get: {
      ...
      parameters: [
        ...
        { name: 'search', in: 'query', required: false, schema: { type: 'string', maxLength: 300 } },
        { name: 'saved', in: 'query', required: false, schema: { type: 'boolean' } },
        { name: 'includeExpired', in: 'query', required: false, schema: { type: 'boolean', default: false } },
      ],
      responses: {
        '200': {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: {
                  prompts: { type: 'array', items: { $ref: '#/components/schemas/ConsolePromptHistory' } },
                },
                required: ['prompts'],
              },
            },
        ...
        '200': {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: { prompt: { $ref: '#/components/schemas/ConsolePromptHistory' } },
                required: ['prompt'],
              },
            },
          },
