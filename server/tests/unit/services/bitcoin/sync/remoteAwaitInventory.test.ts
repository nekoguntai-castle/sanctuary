...
const remoteAwaitInventory = [
  ...
  ['sync/phases/processTransactions/classification.ts', ['fetchAuthenticatedTransactions(ctx, [txid], options)']],
  ['sync/phases/processTransactions/timestampPrefetch.ts', ['getBlockTimestamp(height, network, options)', 'getBlockTimestamp(height, ctx.network, options)']],
