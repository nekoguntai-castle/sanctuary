  ...
  describe("wallet signer account selection", () => {
    describe("explicit signer bindings", () => {
      ...
      it.each([
        ...
        ["malformed path", { derivationPath: "not-a-path" }, "hardened account-level path"],
        ["out-of-range account index", { derivationPath: "m/84'/0'/2147483648'" }, "hardened account-level path"],
