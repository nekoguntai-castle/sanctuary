...
export const BIP32_TEST_VECTORS: Bip32TestVector[] = [
  ...
  // It contains a list of invalid xpub/xprv strings that should be rejected by
  // compliant implementations (wrong version bytes, invalid key prefixes, zero
  // depth with non-zero parent fingerprint/index, unknown versions, invalid
  // private key values, invalid pubkeys, and bad checksums).
  // Since these test deserialization validation rather than key derivation,
  // they are not included as derivation chain vectors here.
];
