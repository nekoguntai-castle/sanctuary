/**
 * BIP-39 Official Test Vectors (Mnemonic Code for Generating Deterministic Keys)
 *
 * These are the official test vectors from the BIP-39 specification:
 * https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki
 * https://github.com/trezor/python-mnemonic/blob/master/vectors.json
 *
 * All test vectors use password "TREZOR" for PBKDF2.
 *
...
export interface Bip39TestVector {
  ...
  mnemonic: string;       // Space-separated mnemonic words
  seed: string;           // Hex-encoded 512-bit seed (derived with password "TREZOR")
  xprv: string;           // BIP-32 root key derived from seed
}

/**
 * English BIP-39 test vectors
 * Password for all vectors: "TREZOR"
 */
export const BIP39_ENGLISH_VECTORS: Bip39TestVector[] = [
  {
...
/**
 * BIP-39 Password used for test vectors
 */
export const BIP39_TEST_PASSWORD = 'TREZOR';
