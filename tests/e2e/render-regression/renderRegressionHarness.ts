...
// Fixed on purpose: elapsed time does not demote an activity-driven settled
...
export const MAINNET_WALLET = {
  ...
  lastSyncedAt: SETTLED_SYNCED_AT,
...
export const NODE_CONFIG = {
  ...
  testnet4SingletonHost: 'testnet4-electrum.example',
  testnet4SingletonPort: 50002,
...
const BITCOIN_STATUS_RESPONSE = {
  ...
  operational: {
    ...
    route: { transport: 'pool', observedAt: '2026-03-11T00:00:00.000Z', serverId: 'server-1' },
    pool: {
