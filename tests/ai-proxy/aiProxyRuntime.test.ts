...
} from "../../ai-proxy/src/aiProxyRuntime";
...
describe("AI proxy runtime helpers", () => {
  ...
  it("requires a configured and allowed endpoint", () => {
    ...
    expect(
      requireConfiguredEndpoint(
        { ...createDefaultAiConfig(), endpoint: "http://ollama:11434" },
        allowedRes as any,
      ),
  ...
  it("classifies endpoint locations for provider diagnostics", () => {
    expect(inferEndpointType("http://ollama:11434")).toBe("container");
