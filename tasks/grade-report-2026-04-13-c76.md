...
| Maintainability         | 8/15      | lizard baseline measured at 83 warnings; jscpd measured at 2.33%; OpenAPI, transaction API, admin API, policy engine, blockchain service, backup service, and process-transactions phase test splits are complete, but largest non-generated TS/TSX file is still a 2064 LOC integration test; clean architecture |
...
| largest_file_lines | 2064 | `server/tests/integration/flows/wallet.integration.test.ts` after the process-transactions phase contract split; next largest validated files include `server/tests/unit/api/auth.routes.registration.test.ts` at 2030 LOC and `server/tests/unit/services/bitcoin/transactionService.create.test.ts` at 1981 LOC when generated verified-vector files are excluded. `server/tests/unit/services/bitcoin/sync/phases.processTransactions.test.ts` is now a 43-line registrar, with process-transactions contract modules capped at 473 LOC. | 3.3 → 0 |
...
2. **Remaining oversized service/integration tests** — the OpenAPI, transaction API, admin API, policy engine, blockchain service, backup service, and process-transactions phase god-files are split, but the current largest non-generated TS/TSX file is now `server/tests/integration/flows/wallet.integration.test.ts` at 2064 LOC, followed by `server/tests/unit/api/auth.routes.registration.test.ts` at 2030 LOC and `server/tests/unit/services/bitcoin/transactionService.create.test.ts` at 1981 LOC when generated verified-vector files are excluded. This keeps criterion 3.3 at 0 until those files are split or the scoring threshold is reframed.
...
- Maintainability 3.3 score impact: **no numeric movement yet**. The OpenAPI, transaction API, admin API, policy engine, blockchain service, backup service, and process-transactions phase god-files are gone, but `server/tests/integration/flows/wallet.integration.test.ts` is now the largest scoped TS/TSX file at 2064 LOC, so the repo-wide largest-file criterion remains at 0.
...
- Next validated targets: `server/tests/integration/flows/wallet.integration.test.ts` (2064 LOC), `server/tests/unit/api/auth.routes.registration.test.ts` (2030 LOC), and `server/tests/unit/services/bitcoin/transactionService.create.test.ts` (1981 LOC), excluding generated verified-vector files.
...
| 3.3 Largest file (after OpenAPI + transaction + admin API + policy engine + blockchain service + backup service + process-transactions splits) | 0 (`wallet.integration.test.ts` 2064 LOC) | 0 | +2 | +2 |
...
- Top non-generated TS/TSX file scan — current largest after the later transaction, admin API, policy engine, blockchain service, backup service, and process-transactions phase splits is `server/tests/integration/flows/wallet.integration.test.ts` at 2064 LOC, followed by `server/tests/unit/api/auth.routes.registration.test.ts` at 2030 LOC and `server/tests/unit/services/bitcoin/transactionService.create.test.ts` at 1981 LOC when generated verified-vector files are excluded.
...
- Current largest non-generated TS/TSX file after the later policy engine, blockchain service, backup service, and process-transactions phase splits is `server/tests/integration/flows/wallet.integration.test.ts` at 2064 LOC, followed by `server/tests/unit/api/auth.routes.registration.test.ts` at 2030 LOC and `server/tests/unit/services/bitcoin/transactionService.create.test.ts` at 1981 LOC when generated verified-vector files are excluded. The admin split closed the named oversized API-test P1 item, while service/integration test files still keep the repo-wide 3.3 score at 0.
...
- Current largest non-generated TS/TSX file after the later blockchain service, backup service, and process-transactions phase splits is `server/tests/integration/flows/wallet.integration.test.ts` at 2064 LOC, followed by `server/tests/unit/api/auth.routes.registration.test.ts` at 2030 LOC and `server/tests/unit/services/bitcoin/transactionService.create.test.ts` at 1981 LOC when generated verified-vector files are excluded. This reduces the policy engine hotspot but does not move the repo-wide 3.3 score yet.
...
- Current largest non-generated TS/TSX file after the later backup service and process-transactions phase splits is `server/tests/integration/flows/wallet.integration.test.ts` at 2064 LOC, followed by `server/tests/unit/api/auth.routes.registration.test.ts` at 2030 LOC and `server/tests/unit/services/bitcoin/transactionService.create.test.ts` at 1981 LOC when generated verified-vector files are excluded. This reduces the blockchain service hotspot but does not move the repo-wide 3.3 score yet.
...
- Current largest non-generated TS/TSX file after the later process-transactions phase split is `server/tests/integration/flows/wallet.integration.test.ts` at 2064 LOC, followed by `server/tests/unit/api/auth.routes.registration.test.ts` at 2030 LOC and `server/tests/unit/services/bitcoin/transactionService.create.test.ts` at 1981 LOC when generated verified-vector files are excluded. This reduces the backup service hotspot but does not move the repo-wide 3.3 score yet.
...
- Current largest non-generated TS/TSX file after the split is `server/tests/integration/flows/wallet.integration.test.ts` at 2064 LOC, followed by `server/tests/unit/api/auth.routes.registration.test.ts` at 2030 LOC and `server/tests/unit/services/bitcoin/transactionService.create.test.ts` at 1981 LOC when generated verified-vector files are excluded. This reduces the process-transactions phase hotspot but does not move the repo-wide 3.3 score yet.
