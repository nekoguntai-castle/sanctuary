...
2. **Refresh token TTL.** 7 days is the recommended default. If the security policy requires shorter (e.g., 24h for paranoid deployments), surface this as an env var and document it in `docs/how-to/operations-runbooks.md`.
