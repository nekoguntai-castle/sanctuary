...
- Sweep for any admin surfaces outside the modular admin router and continue documenting any remaining non-wallet public domains beyond the completed price, Bitcoin utility/node, and sync-management coverage.
