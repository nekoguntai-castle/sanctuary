...
- Keep route-surface sweeps running as route modules change; root `/health`, `/metrics`, and `/api/v1/docs` remain operational/documentation surfaces rather than client API contracts.
