...
- Continue documenting remaining admin surfaces beyond version/settings/feature flags/audit logs/users/groups/system policies/backup/support-package/node configuration/proxy tests/Electrum servers and any remaining non-wallet public domains.
