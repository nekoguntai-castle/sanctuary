...
Status: **Broad OpenAPI-backed contract checkpoint expanded as of 2026-04-12**
...
- Sweep for any admin surfaces outside the modular admin router and continue documenting any remaining non-wallet public domains beyond the completed price, Bitcoin utility/node, sync-management, and transaction-helper coverage.
