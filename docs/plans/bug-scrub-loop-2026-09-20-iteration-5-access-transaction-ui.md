...
PR #1258 merged as `4aef77802dafb973d523e81c888f2c92eb6258a7`. The merge commit is reachable from `origin/main`. All five exact-head PR workflows (18187–18191), all five exact-merge target push workflows (18197–18201), and both combined commit statuses passed. The dashboard and wallet-rename findings are resolved in the durable run state. Start the next eight-domain scrub from the final target SHA after this delivery record lands.
