...
export const SidebarFooter: React.FC<SidebarFooterProps> = ({
  ...
  <div className="flex-shrink-0 border-t border-sanctuary-200 dark:border-sanctuary-800">
    <div className="flex items-center justify-between px-4 md:px-2 lg:px-4 py-3 md:flex-col md:gap-2 lg:flex-row lg:gap-0">
      <div className="flex items-center gap-2.5">
        ...
        <span className="text-sm font-medium text-sanctuary-700 dark:text-sanctuary-300 md:hidden lg:inline">
          {user?.username}
        </span>
      </div>
      <button
    ...
    <div className="flex items-center justify-between px-4 md:px-2 lg:px-4 py-2 md:flex-col md:gap-1 lg:flex-row lg:gap-0">
