      ...
      <div className="relative surface-elevated rounded-xl shadow-2xl border border-sanctuary-200 dark:border-sanctuary-700 max-w-md w-full max-h-[90vh] overflow-y-auto animate-modal-enter">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              <a
                href="https://codeberg.org/nekoguntai-castle/sanctuary"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <div className="flex items-center space-x-3">
                  <svg className="h-5 w-5 text-sanctuary-600 dark:text-sanctuary-400" viewBox="0 0 4.6666 4.6666" fill="currentColor" aria-hidden="true"><path d="M2.333.0193c-1.279 0-2.317 1.038-2.317 2.317 0 .997.628 1.844 1.51 2.169l.798-1.825a.999.999 0 0 1-.187-1.157.999.999 0 0 1 .894-.553.999.999 0 0 1 .894.553.999.999 0 0 1-.186 1.157l.798 1.826c.882-.325 1.51-1.172 1.51-2.17C4.65 1.057 3.612.019 2.333.019Z"/></svg>
              ...
              <a
                href="https://codeberg.org/nekoguntai-castle/sanctuary/releases"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-between p-3 rounded-lg surface-secondary hover:bg-sanctuary-100 dark:hover:bg-sanctuary-700 transition-colors"
              >
