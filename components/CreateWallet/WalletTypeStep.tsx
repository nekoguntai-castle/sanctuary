  ...
  <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <button
              ...
              className={`p-6 rounded-2xl border-2 transition-all duration-200 flex flex-col items-center text-center space-y-4 active:scale-[0.98] ${walletType === WalletType.SINGLE_SIG ? 'border-emerald-600 bg-emerald-50 dark:border-emerald-400 dark:bg-emerald-900/20 shadow-md shadow-emerald-100 dark:shadow-emerald-900/20' : 'border-sanctuary-200 dark:border-sanctuary-800 hover:border-sanctuary-400 hover:shadow-sm'}`}
          >
          ...
          <button
              ...
              className={`p-6 rounded-2xl border-2 transition-all duration-200 flex flex-col items-center text-center space-y-4 active:scale-[0.98] ${walletType === WalletType.MULTI_SIG ? 'border-warning-600 bg-warning-50 dark:border-warning-400 dark:bg-warning-900/20 shadow-md shadow-warning-100 dark:shadow-warning-900/20' : 'border-sanctuary-200 dark:border-sanctuary-800 hover:border-sanctuary-400 hover:shadow-sm'}`}
          >
