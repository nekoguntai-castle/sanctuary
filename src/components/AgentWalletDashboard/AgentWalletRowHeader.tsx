...
import type { AgentWalletDashboardRow } from '../../api/admin';
...
export function AgentWalletRowHeader({ row }: { row: AgentWalletDashboardRow }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      {canSpendNow(row) && (
        <span className="inline-flex items-center gap-1 rounded-full border border-success-200 bg-success-50 px-2 py-0.5 text-xs font-medium text-success-700 dark:border-success-800 dark:bg-success-900/20">
