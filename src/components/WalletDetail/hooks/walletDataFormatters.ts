...
export function formatWalletFromApi(apiWallet: Wallet, userId: string): Wallet {
  ...
  return {
    ...
    requestedIncrementalSyncGeneration: apiWallet.requestedIncrementalSyncGeneration,
    claimedIncrementalSyncGeneration: apiWallet.claimedIncrementalSyncGeneration,
    processedIncrementalSyncGeneration: apiWallet.processedIncrementalSyncGeneration,
    incrementalSyncClaimedAt: apiWallet.incrementalSyncClaimedAt,
    incrementalSyncLeaseExpiresAt: apiWallet.incrementalSyncLeaseExpiresAt,
    syncActionRequiredAt: apiWallet.syncActionRequiredAt,
    requestedFullResyncGeneration: apiWallet.requestedFullResyncGeneration,
    preparedFullResyncGeneration: apiWallet.preparedFullResyncGeneration,
    processedFullResyncGeneration: apiWallet.processedFullResyncGeneration,
    // Sharing info
