          ...
          >
            ...
            <div className="flex gap-1">
              ...
              <button
                ...
                disabled={sharingLoading}
                className="text-xs px-1.5 py-0.5 rounded bg-warning-100 dark:bg-warning-900/30 text-warning-700 hover:bg-warning-200 dark:hover:bg-warning-900/50 disabled:opacity-50"
              >
                Sign
              </button>
              <button
