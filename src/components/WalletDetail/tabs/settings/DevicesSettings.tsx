          ...
          {devices.map(d => {
            ...
            return (
              <li key={d.id}>
                <Link
                  to={`/devices/${d.id}`}
                  className={`py-3 flex justify-between items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 hover:bg-sanctuary-100 dark:hover:bg-sanctuary-800 -mx-2 px-2 rounded-lg transition-colors ${hasAccountMismatch ? 'border-l-4 border-rose-500' : ''}`}
                >
