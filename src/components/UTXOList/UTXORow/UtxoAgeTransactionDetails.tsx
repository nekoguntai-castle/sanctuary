  ...
  return (
    <div className="text-xs text-sanctuary-400 text-right">
      ...
      {explorerUrl ? (
        ...
        // Unresolved or unconfigured explorer for this network — plain text
        // beats a link built from another network's base.
        <span
          className="inline-flex items-center font-mono text-[10px] opacity-70"
