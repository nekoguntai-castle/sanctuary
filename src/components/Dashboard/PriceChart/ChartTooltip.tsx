...
export function ChartTooltip({ active, payload, label, format, formatLabel }: ChartTooltipProps) {
  ...
  return (
    <div className="surface-elevated font-sans rounded-lg px-3 py-2 shadow-lg border border-sanctuary-200 dark:border-sanctuary-700">
      <p className="text-[10px] uppercase tracking-wider text-sanctuary-400 mb-0.5">{typeof label === 'number' && Number.isFinite(label) ? formatLabel(label) : null}</p>
