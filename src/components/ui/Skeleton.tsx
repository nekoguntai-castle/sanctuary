...
export const DashboardSkeleton: React.FC = () => (
  <div
    ...
    aria-hidden="true"
  >
    {/* Page-level period: the first visible control on the populated dashboard. */}
    <div
      className="flex items-center justify-between gap-4"
      data-skeleton-section="period"
    >
      <Skeleton className="h-3 w-20" />
      <Skeleton className="h-8 w-56 rounded-lg" />
    </div>

    {/* Total balance is the dashboard's primary plane. */}
    <div
      className="surface-elevated rounded-xl p-5 border border-sanctuary-200 dark:border-sanctuary-800"
      data-skeleton-section="balance"
    >
    ...
    {/* Wallets and activity are independent full-width planes. */}
    <div
      className="surface-elevated rounded-xl p-4 border border-sanctuary-200 dark:border-sanctuary-800"
      data-skeleton-section="wallets"
    >
      <Skeleton className="h-4 w-36 mb-4" />
      <Skeleton className="h-3 w-48 mb-3" />
      <Skeleton className="h-4 w-full rounded-full mb-5" />
    ...
    <div
      className="surface-elevated rounded-xl p-5 border border-sanctuary-200 dark:border-sanctuary-800"
      data-skeleton-section="activity"
    >
    ...
    {/* Ambient telemetry follows the user's balance and activity. */}
    <div
    ...
    {/* The current dashboard places the block visualizer last. */}
    <div
      className="surface-elevated rounded-xl p-4 border border-sanctuary-200 dark:border-sanctuary-800"
      data-skeleton-section="mempool"
    >
      <div className="flex items-center justify-between gap-4 px-2 mb-3">
