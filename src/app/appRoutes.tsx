...
const NodeConfig = lazy(async () => ({
  default: (await import("../../components/NodeConfig")).NodeConfig,
}));
const UsersGroups = lazy(async () => ({
...
const Variables = lazy(async () => ({
  default: (await import("../../components/Variables")).Variables,
}));
const BackupRestore = lazy(async () => ({
