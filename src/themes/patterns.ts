...
const baseGlobalPatterns = defineBaseBackgroundPatterns([
  ...
  },
  {
    ...
    // These patterns are defined in src/index.html CSS - don't override them
  ...
  },
  {
    ...
    // This pattern uses CSS from src/index.html for fixed background positioning
